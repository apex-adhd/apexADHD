...
<div id="homePage">
	<header>
        <div class="container">
			<div class="intro-lead-in text-center" style="margin-top:7%;">Providing one-on-one coaching, group training, and ADHD awareness around the world!</div>
            <div class="intro-text">
                <div class="intro-heading video-container"><iframe src="https://www.youtube.com/embed/nGeKSiCQkPw" frameborder="0" allowfullscreen></iframe></div>  
            </div>
			<div class="header-subsection text-center">
				<div class="intro-subtext col-lg-6" style="text-align:justify;">
					All of our programs are conducted via Skype or over the phone so you can receive training from us anywhere in the 
					world from the comfort of your own home. This also let's us get you into action on achieving your 
					goals DURING the coaching session!
				</div>
				<div class="intro-action col-lg-6">
					<router-link to="/contact" class="btn-action btn btn-xl">Contact Us!</router-link>
				</div>			
			</div>
		...
		<div id="portfolio" class="box">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#homeChaos" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
						</div>
						<img src="../assets/img/StockSnap_DH9WMRSBHD.jpg" class="img-responsive" alt>
					</a>
					<div class="portfolio-caption">
						<h4>My Home is Chaos!</h4>
						<p class="text-muted">
						Do you feel like your home is filled with chaos the minute you walk through the door?
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#exam" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>HELP! Get Me Through This Exam!</h4>
						<p class="text-muted">
							Big exam coming up? In panic mode trying to sit and focus for it?
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#findJob" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>Find a Job and Keep It </h4>
						<p class="text-muted">
							Feeling hopeless about searching for a new job? Worried that once you are offered one you’ll have trouble 
							keeping it like you have in the past? 						
						</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#supportFamily" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>Learn How to Support Your ADHD Family Member</h4>
						<p class="text-muted">
							Do you have a child, significant other, or parent with ADHD? Frustrated that you don’t know the best 
							way to help them? Wish you knew more about how their brain works so you can understand them more? Exhausted 
							from asking them to get support or coaching and having them be unwilling to make changes?					
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#students" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#loseWeight" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>Lose Weight and Keep It Off</h4>
						<p class="text-muted">
							Does losing weight feel like a never ending battle? Having trouble fighting your impulses to keep off the weight once you lose it?				
						</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#bigChange" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>I’m About to Have a BIG Change (Pregnancy, Moving, Starting a New Career or College, Marriage, Divorce etc)</h4>
						<p class="text-muted">
							Are things in your life about to drastically change? Nervous that you won’t be able to handle the transition and create 
							new routines on your own?					
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#semester" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>I Need to Get Through This Semester!</h4>
						<p class="text-muted">
							Do you want support throughout your entire semester? Feeling like your child could use extra help to learn how to study with ADHD?			
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#loseJob" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>I’m Going to Lose My Job if I Don’t Get Organized</h4>
						<p class="text-muted">
							On the brink of losing your job from being written up a million times? Feel like you’ll never get that promotion 
							you’ve been working towards? Want to feel more confident at work?			
						</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#adhdSymptom" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>I Wish I Didn’t Have This Specific ADHD Symptom </h4>
						<p class="text-muted">
							Have a specific ADHD symptom that creates challenges in all the areas of your life?				
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#loveLife" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>Find Love in the Middle of a Scattered and Busy Life (3 months?)</h4>
						<p class="text-muted">
							What to find the love of your life but keep hitting dead ends? Feel like dating takes too much time in your overpacked 
							life? Want more confidence when going on dates? Feel like you always fall for drama filled relationships?
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#relationships" class="portfolio-link" data-toggle="modal">
						<div class="portfolio-hover">
							<div class="portfolio-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
					...
					<div class="portfolio-caption">
						<h4>I Am So Tired of Drama in All My Relationships! Help Me Communicate!!!</h4>
						<p class="text-muted">
							Having trouble communicating with your Partner? Children? Siblings? Parents? Co-Workers? Friends? Everyone???
						</p>
					</div>
				</div>
			</div>
    ...
    <div class="portfolio-modal modal fade" id="homeChaos" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="portfolio-modal modal fade" id="exam" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul>
									...
									<li>Study for LESS time, while absorbing MORE information!</li>
									<li>Practice test taking skills to calm your nerves during the exam</li>
									<li>Manage distractions and increase your focus while studying and during the test</li>
									<li>Build your confidence before test day!</li>
								</ul>
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                            </div>
                        </div>
	...
	<div class="portfolio-modal modal fade" id="findJob" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
	...
	<div class="portfolio-modal modal fade" id="supportFamily" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul>
									...
									<li>Discuss specific challenges you face with your loved one</li>
	...
	<div class="portfolio-modal modal fade" id="students" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
	...
	<div class="portfolio-modal modal fade" id="loseWeight" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
	...
	<div class="portfolio-modal modal fade" id="bigChange" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
	...
	<div class="portfolio-modal modal fade" id="semester" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul style="text-align:left;">
									...
									<li>Stay motivated to complete assignments on time!</li>
									<li>Create personalized study strategies to help you get the most out of your study time!</li>
									<li>Study for LESS time, while absorbing MORE information!</li>
									<li>Practice test taking skills to calm your nerves during the exams</li>
	...
	<div class="portfolio-modal modal fade" id="loseJob" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">
									...
									and coworkers, we will help you create personalized strategies to move you forward in your job and career!
									<br>
									In this program, you will:
									
								</p>
								<ul style="text-align:left;">
									<li>Reduce overwhelm related to chaos at your job!</li>
									<li>Make managing paperwork simpler and less stressful</li>
									<li>Identify challenges at your job so that they don’t get in the way of your success</li>
									<li>Be able to get to work on time and manage your time while at work</li>
									<li>Maximize your efficiency at work</li>
	...
	<div class="portfolio-modal modal fade" id="loveLife" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
		...
		<div class="portfolio-modal modal fade" id="relationships" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul style="text-align:left;">
									<li>Reduce drama in every area of your life</li>
									<li>Learn ways to communicate that will have you be heard and acknowledged by the people most important to you</li>
									<li>Understand your specific ADHD challenges that get in the way of communicating</li>
									<li>Be able to slow down and stay focused in conversations</li>
									<li>Get along better with the people in your life who drive you the most crazy</li>
									<li>Repair your relationships</li>
									<li>Gain skills to confidently speak in groups and one on one</li>
									<li>Simplify managing social commitments so you don’t feel like you are always letting people down</li>
									<li>Feel like your loved ones finally understand you and what’s important to you</li>
								</ul>
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                            </div>
                        </div>
		...
		<div class="portfolio-modal modal fade" id="adhdSymptom" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">
									...
									Through, Low Motivation, Hard Time Transitioning from One Task to Another, Zoning Out Frequently, Feeling Scattered, 
									Trouble with Details/Multistep Tasks (If it’s not listed we can create program for you!) We’ll work with you to teach 
									you how to manage this specific symptom
									<br>
									In this program, you will:
								</p>
								<ul style="text-align:left;">
									<li>Learn the neuroscience behind your specific ADHD symptom</li>
									<li>Gain personalized tools to help you learn how to manage your ADHD symptom</li>
									<li>Use your brain to master your ADHD symptom instead of feeling you are never in control of it</li>
